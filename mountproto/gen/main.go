...
// runtimeProtocolVersion is fusekit's own runtime protocol number, revved off
// daemonkit's withdrawn wire.ProtocolVersion.
...
var messages = []message{
	...
	request("ProvisionTenantRequest", field{JSON: "tenant", Go: "Tenant", Type: "TenantID"}, field{JSON: "definition", Go: "Definition", Type: "TenantDefinition"}),
	...
	request("ReplaceTenantRequest", field{JSON: "tenant", Go: "Tenant", Type: "TenantID"}, field{JSON: "expected_generation", Go: "ExpectedGeneration", Type: "uint64"}, field{JSON: "definition", Go: "Definition", Type: "TenantDefinition"}),
	...
	request("RemoveTenantRequest", field{JSON: "tenant", Go: "Tenant", Type: "TenantID"}, field{JSON: "generation", Go: "Generation", Type: "uint64"}),
	...
	request("StateRequest", field{JSON: "tenant", Go: "Tenant", Type: "TenantID"}),
...
func schemaBuild() string {
	raw, err := json.Marshal(struct {
		...
		Version: 1, RuntimeProtocol: runtimeProtocolVersion, Enums: enums, Messages: messages,
	})
	if err != nil {
		panic(err)
	}
