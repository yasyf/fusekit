...
var enums = []enum{
	{Name: "Operation", Values: []string{"catalog.root", "catalog.head", "catalog.snapshot", "catalog.changes_since", "catalog.lookup", "catalog.lookup_name", "catalog.open_at", "catalog.mutate", "tenant.prepare", "presentation_lease.commit", "presentation_lease.renew", "presentation_lease.release", "activation.ack", "activation.notify", "source_authority.publish_desired_fleet", "source_authority.read_desired_fleet", "broker.open", "broker.bind_domain", "broker.forward"}},
